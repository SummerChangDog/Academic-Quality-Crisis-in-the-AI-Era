...
# nohup python -m pipeline.get_metrics 2025 --num_sample 200 --seed 101 &> logs/2025.txt &
...
from metrics.ref_ai import process_paper_citations
...
if __name__ == '__main__':
    ...
    for domain, arxiv_id in downloaded_papers:
        ...
        ref_path = os.path.join("data/papers", arxiv_id, "ref.json") 
        ...
        try:
            ...
            # 核心新增：调用ref_ai的函数计算引用AI率
            print(f"[REF_AI] 正在计算 {arxiv_id} 的引用AI率...")
            citation_ai_rate = process_paper_citations(arxiv_id, ref_path)
            ...
            eval_results = {
                ...
                "citation_ai_rate": citation_ai_rate
            }
